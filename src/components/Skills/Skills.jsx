...
import TechStackSphere from "../Techsphere/techstacksphere.jsx";
import { SkillsInfo } from "../../constants";
import Tilt from "react-parallax-tilt";
const Skills = () => (
  <section
    id="skills"
    className="py-24 px-[6vw] md:px-[5vw] lg:px-[12vw] font-sans bg-skills-gradient clip-path-custom"
  >
    {/* Section Title */}
    ...
    <div className="flex flex-wrap gap-1 lg:gap-5 py-10 justify-between">
      {SkillsInfo.map((category) => (
        <div
          ...
          shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] hover:shadow-purple-500/90 hover:-translate-y-2 transition-transform duration-300"
        >
